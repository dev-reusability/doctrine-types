...
use DevReusability\DoctrineTypes\Persistence\Type\CheckoutDeliveryAddressType;
...
class CheckoutDeliveryAddressTypeTest extends TestCase
{
    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->type = new CheckoutDeliveryAddressType();
    }
