...
use DevReusability\DoctrineTypes\Persistence\Type\OrderProductItemsType;
...
class OrderProductItemsTypeTest extends TestCase
{
    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->type = new OrderProductItemsType();
    }
