...
use DevReusability\DoctrineTypes\Persistence\Type\PurchaseReminderTypeType;
...
class PurchaseReminderTypeTypeTest extends TestCase
{
    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->type = new PurchaseReminderTypeType();
    }
