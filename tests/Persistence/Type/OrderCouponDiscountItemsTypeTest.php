...
use DevReusability\DoctrineTypes\Persistence\Type\OrderCouponDiscountItemsType;
...
class OrderCouponDiscountItemsTypeTest extends TestCase
{
    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->type = new OrderCouponDiscountItemsType();
    }
