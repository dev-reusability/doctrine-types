...
use DevReusability\DoctrineTypes\Persistence\Type\IntakeReminderTypeType;
...
class IntakeReminderTypeTypeTest extends TestCase
{
    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->type = new IntakeReminderTypeType();
    }
