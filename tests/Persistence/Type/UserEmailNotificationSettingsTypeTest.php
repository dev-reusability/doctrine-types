...
use DevReusability\DoctrineTypes\Persistence\Type\UserEmailNotificationSettingsType;
...
class UserEmailNotificationSettingsTypeTest extends TestCase
{
    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->type = new UserEmailNotificationSettingsType();
    }
