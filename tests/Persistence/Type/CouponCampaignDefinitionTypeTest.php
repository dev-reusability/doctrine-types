...
use DevReusability\DoctrineTypes\Persistence\Type\CouponCampaignDefinitionType;
...
class CouponCampaignDefinitionTypeTest extends TestCase
{
    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->type = new CouponCampaignDefinitionType();
    }
