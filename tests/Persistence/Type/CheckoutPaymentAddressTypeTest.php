...
use DevReusability\DoctrineTypes\Persistence\Type\CheckoutPaymentAddressType;
...
class CheckoutPaymentAddressTypeTest extends TestCase
{
    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->type = new CheckoutPaymentAddressType();
    }
