...
use DevReusability\DoctrineTypes\Persistence\Type\CheckoutUserDetailsType;
...
class CheckoutUserDetailsTypeTest extends TestCase
{
    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->type = new CheckoutUserDetailsType();
    }
