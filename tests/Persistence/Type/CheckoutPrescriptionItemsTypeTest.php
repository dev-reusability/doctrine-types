...
use DevReusability\DoctrineTypes\Persistence\Type\CheckoutPrescriptionItemsType;
...
class CheckoutPrescriptionItemsTypeTest extends TestCase
{
    protected function setUp(): void
    {
        $this->platform = $this->createMock(AbstractPlatform::class);
        $this->type = new CheckoutPrescriptionItemsType();
    }
